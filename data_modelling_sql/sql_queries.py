...
CREATE TABLE IF NOT EXISTS udacity.songlays (
...
INSERT  INTO  udacity.songlays ( songplay_id
                               , time_id
                               , user_id
                               , level
                               , song_id
...
# song_select = ("""
#
# SELECT songs.artist_id, songs.song_id
...
Where A.title = %s  AND  cast(A.duration as float)=%s AND B.name=%s
""")
